                ...
                <div className="flex flex-col fixed inset-0 bg-black bg-opacity-50 items-center">
                    <nav className="w-full bg-[#ff6b00] p-6 shadow-b-lg">
                        <div className="flex mt-[10px] justify-center">
                            <p className="text-white font-bold text-[22px]">Situation Report Edit Draft</p>
                        </div>
                    </nav>
                    <div className="bg-white p-5 w-full min-h-full overflow-hidden">
                        <div className="overflow-y-auto max-h-[70vh]"> {/* Scrollable container */}
                            ...
                            <input
                                ...
                                value={editItem.eventName}
                                onChange={handleInputChange}
                                className="mb-4 border rounded p-2 mt-2 text-gray-400 w-full"
                            />

                            <label className="font-semibold mb-1">Nama Kejadian*</label>
                            <input
                                type="text"
                                name="eventType"
                                placeholder="Event Type"
                                value={editItem.eventType}
                                onChange={handleInputChange}
                                className="mb-4 border rounded p-2 mt-2 text-gray-400 w-full"
                            />
                            ...
                            <label className="font-semibold mb-1">Pic Lapangan*</label>
                            <input
                                type="text"
                                name="pic"
                                placeholder="PIC"
                        ...
                        <div className="flex justify-between mt-[30px]">
                            <button className="w-[100px] h-[40px] bg-white font-bold text-black border border-orange-300 rounded-lg" onClick={() => setIsEditing(false)}>Cancel</button>
                            <button className="w-[100px] h-[40px] bg-[#ff6b00] font-bold text-white rounded-l" onClick={handleSaveEdit}>Save</button>
                        </div>
                    </div>
                </div>
            )}
