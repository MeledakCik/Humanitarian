export async function GET(req) {
    try {
        ...
        const dampakSiteId = searchParams.get("dampak_site_id");
        const apiUrl = `https://humanitarian1-rz-be-dev1.cnt.id/apid/get_dampak_sarpras${dampakSiteId ? `?dampak_site_id=${dampakSiteId}` : ''}`;
