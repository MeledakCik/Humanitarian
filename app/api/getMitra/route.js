export async function GET(req) {
    try {
        ...
        const mitraSiteId = searchParams.get("mitra_dist_id");
        const apiUrl = `https://humanitarian1-rz-be-dev1.cnt.id/apid/get_mitra${mitraSiteId ? `?mitra_dist_id=${mitraSiteId}` : ''}`;
